...
export interface IAllegraAuxiliaryData {
    metadata?: TxMetadata;
...
export class AllegraAuxiliaryData
    implements IAllegraAuxiliaryData, ToCbor, ToJson
{
    ...
    constructor(
        auxData: IAllegraAuxiliaryData,
        readonly cborRef: SubCborRef | undefined = undefined
    )
    {
        if(!(
            hasOwn( auxData, "metadata" )
        ))throw new Error("'AllegraAuxiliaryData' is missing 'metadata' field");
        ...
        ))throw new Error("'AllegraAuxiliaryData' :: 'metadata' field was not instance of 'TxMetadata'");
    ...
    static fromCbor( cStr: CanBeCborString ): AllegraAuxiliaryData
    {
        return AllegraAuxiliaryData.fromCborObj( Cbor.parse( forceCborString( cStr ), { keepRef: true } ) );
    }
    static fromCborObj( cObj: CborObj ): AllegraAuxiliaryData
    {
