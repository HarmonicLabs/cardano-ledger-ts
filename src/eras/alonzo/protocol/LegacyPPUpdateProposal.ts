...
import { AlonzoProtocolParameters, isPartialProtocolParameters, partialProtocolParametersFromCborObj, partialProtocolParametersToCborObj, partialProtocolParamsToJson } from "./AlonzoProtocolParameters";
...
export type LegacyPPUpdateMap = {
    ...
    changes: Partial<AlonzoProtocolParameters>
}[];
