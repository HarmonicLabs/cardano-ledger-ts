    ...
    implements IBabbageTxBody, ToCbor, ToJson
{
     ...
     * @throws only if the the `body` parameter does not respect the `IBabbageTxBody` interface
     *      **DOES NOT THROW** if the transaction is unbalanced; that needs to be checked using `BabbageTxBody.isValueConserved` static method
     */
    constructor(
        body: IBabbageTxBody,
