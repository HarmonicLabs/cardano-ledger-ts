...
export interface DijkstraPParamsDrepVotingThresholds {
...
export function isDijkstraPParamsDrepVotingThresholds( stuff: any ): stuff is DijkstraPParamsDrepVotingThresholds
{
...
export function dijkstraDrepVotingThresholdsToCborObj( drepVotingThresholds: DijkstraPParamsDrepVotingThresholds ): CborArray
{
...
export function tryGetDijkstraPParamsDrepVotingThresholdsFromCborObj( cbor: CborObj | undefined ): DijkstraPParamsDrepVotingThresholds | undefined
{
    if(!(
