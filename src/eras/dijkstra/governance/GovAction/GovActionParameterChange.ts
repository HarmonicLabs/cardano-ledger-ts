...
import { isPartialDijkstraProtocolParameters, partialDijkstraProtocolParametersToCborObj, partialDijkstraProtocolParametersToData, DijkstraProtocolParameters } from "../../protocol";
export interface IGovActionParameterChange {
    govActionId?: ITxOutRef | undefined,
    protocolParamsUpdate: Partial<DijkstraProtocolParameters>,
...
export function isIGovActionParameterChange( stuff: any ): stuff is IGovActionParameterChange
{
    return isObject( stuff ) && (
        ...
        isPartialDijkstraProtocolParameters( stuff.protocolParamsUpdate ) &&
    ...
    implements IGovAction, IGovActionParameterChange, ToCbor, ToData
{
    ...
    readonly protocolParamsUpdate: Partial<DijkstraProtocolParameters>;
    ...
    toCborObj(): CborArray
    {
        ...
        return new CborArray([
            ...
            partialDijkstraProtocolParametersToCborObj( this.protocolParamsUpdate ),
    ...
    toData( v?: ToDataVersion ): DataConstr
    {
        ...
        return new DataConstr(
            0, [
                ...
                partialDijkstraProtocolParametersToData( this.protocolParamsUpdate ),
