...
export interface IDijkstraCertUpdateDrep {
    drepCredential: Credential,
    anchor?: IAnchor | undefined,
}

export class DijkstraCertUpdateDrep
    implements ICert, IDijkstraCertUpdateDrep
{
    ...
    constructor(
        { drepCredential, anchor }: IDijkstraCertUpdateDrep,
    ...
    static fromCborObj( cbor: CborObj ): DijkstraCertUpdateDrep
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'DijkstraCertUpdateDrep'");

        return new DijkstraCertUpdateDrep({
