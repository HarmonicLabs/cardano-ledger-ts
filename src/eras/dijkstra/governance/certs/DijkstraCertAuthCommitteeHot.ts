...
export interface IDijkstraCertAuthCommitteeHot {
    coldCredential: Credential,
    hotCredential : Credential,
}

export class DijkstraCertAuthCommitteeHot
    implements ICert, IDijkstraCertAuthCommitteeHot, ToCbor, ToJson
{
    ...
    constructor(
        { coldCredential, hotCredential }: IDijkstraCertAuthCommitteeHot,
    ...
    static fromCborObj( cbor: CborObj ): DijkstraCertAuthCommitteeHot
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'DijkstraCertAuthCommitteeHot'");

        return new DijkstraCertAuthCommitteeHot({
