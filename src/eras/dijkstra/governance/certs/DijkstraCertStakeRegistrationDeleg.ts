...
export interface IDijkstraCertStakeRegistrationDeleg {
    stakeCredential: Credential,
    poolKeyHash: CanBeHash28,
    coin: Coin,
}

export class DijkstraCertStakeRegistrationDeleg
    implements ICert, IDijkstraCertStakeRegistrationDeleg
{
    ...
    constructor(
        { stakeCredential, poolKeyHash, coin }: IDijkstraCertStakeRegistrationDeleg,
    ...
    static fromCbor( cbor: CanBeCborString ): DijkstraCertStakeRegistrationDeleg
    {
        return DijkstraCertStakeRegistrationDeleg.fromCborObj( Cbor.parse( forceCborString( cbor ) ) );
    } 
    static fromCborObj( cbor: CborObj ): DijkstraCertStakeRegistrationDeleg
    {
        if(!(
        ...
        )) throw new Error("invalid cbor for 'DijkstraCertStakeRegistrationDeleg'");

        return new DijkstraCertStakeRegistrationDeleg({
