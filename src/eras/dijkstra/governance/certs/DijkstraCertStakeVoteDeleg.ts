...
export interface IDijkstraCertStakeVoteDeleg {
    stakeCredential: Credential,
    poolKeyHash: CanBeHash28,
    drep: DRepLike,
}

export class DijkstraCertStakeVoteDeleg
    implements ICert, IDijkstraCertStakeVoteDeleg
{
    ...
    constructor(
        { stakeCredential, poolKeyHash, drep }: IDijkstraCertStakeVoteDeleg,
    ...
    static fromCborObj( cbor: CborObj ): DijkstraCertStakeVoteDeleg
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'DijkstraCertStakeVoteDeleg'");

        return new DijkstraCertStakeVoteDeleg({
