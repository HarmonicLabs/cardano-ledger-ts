...
export interface IDijkstraCertResignCommitteeCold {
    coldCredential: Credential,
    anchor?: IAnchor | undefined,
}

export class DijkstraCertResignCommitteeCold
    implements ICert, IDijkstraCertResignCommitteeCold
{
    ...
    constructor(
        { coldCredential, anchor }: IDijkstraCertResignCommitteeCold,
    ...
    static fromCborObj( cbor: CborObj ): DijkstraCertResignCommitteeCold
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'DijkstraCertResignCommitteeCold'");

        return new DijkstraCertResignCommitteeCold({
