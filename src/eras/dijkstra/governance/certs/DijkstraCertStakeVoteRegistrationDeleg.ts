...
export interface IDijkstraCertStakeVoteRegistrationDeleg {
...
export class DijkstraCertStakeVoteRegistrationDeleg
    implements ICert, IDijkstraCertStakeVoteRegistrationDeleg
{
    ...
    constructor(
        { stakeCredential, poolKeyHash, drep, coin }: IDijkstraCertStakeVoteRegistrationDeleg,
    ...
    static fromCborObj( cbor: CborObj ): DijkstraCertStakeVoteRegistrationDeleg
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'DijkstraCertStakeVoteRegistrationDeleg'");

        return new DijkstraCertStakeVoteRegistrationDeleg({
