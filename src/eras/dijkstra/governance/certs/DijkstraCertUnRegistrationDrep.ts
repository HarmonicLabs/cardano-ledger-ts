...
export interface IDijkstraCertUnRegistrationDrep {
    drepCredential: Credential,
    coin: Coin
}

export class DijkstraCertUnRegistrationDrep
    implements ICert, IDijkstraCertUnRegistrationDrep
{
    ...
    constructor(
        { drepCredential, coin }: IDijkstraCertUnRegistrationDrep,
    ...
    static fromCborObj( cbor: CborObj ): DijkstraCertUnRegistrationDrep
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'DijkstraCertUnRegistrationDrep'");

        return new DijkstraCertUnRegistrationDrep({
