...
export interface IDijkstraCertUnRegistrationDeposit {
    stakeCredential: Credential,
    deposit: Coin
}

export class DijkstraCertUnRegistrationDeposit
    implements ICert, IDijkstraCertUnRegistrationDeposit
{
    ...
    constructor(
        { stakeCredential, deposit }: IDijkstraCertUnRegistrationDeposit,
    ...
    static fromCborObj( cbor: CborObj ): DijkstraCertUnRegistrationDeposit
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'DijkstraCertUnRegistrationDeposit'");

        return new DijkstraCertUnRegistrationDeposit({
