...
export interface IDijkstraCertVoteRegistrationDeleg {
    stakeCredential: Credential,
    drep: DRepLike,
    coin: Coin,
}

export class DijkstraCertVoteRegistrationDeleg
    implements ICert, IDijkstraCertVoteRegistrationDeleg
{
    ...
    constructor(
        { stakeCredential, drep, coin }: IDijkstraCertVoteRegistrationDeleg,
    ...
    static fromCborObj( cbor: CborObj ): DijkstraCertVoteRegistrationDeleg
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'DijkstraCertVoteRegistrationDeleg'");

        return new DijkstraCertVoteRegistrationDeleg({
