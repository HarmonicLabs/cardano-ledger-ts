...
export interface IDijkstraCertRegistrationDrep {
    drepCredential: Credential,
    coin: Coin
    anchor?: IAnchor | undefined,
}

export class DijkstraCertRegistrationDrep
    implements ICert, IDijkstraCertRegistrationDrep
{
    ...
    constructor(
        { drepCredential, coin, anchor }: IDijkstraCertRegistrationDrep,
    ...
    static fromCborObj( cbor: CborObj ): DijkstraCertRegistrationDrep
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'DijkstraCertRegistrationDrep'");

        return new DijkstraCertRegistrationDrep({
