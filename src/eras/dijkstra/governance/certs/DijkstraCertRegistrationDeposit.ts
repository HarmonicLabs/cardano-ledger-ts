...
export interface IDijkstraCertRegistrationDeposit {
    stakeCredential: Credential,
    deposit: Coin
}

export class DijkstraCertRegistrationDeposit
    implements ICert, IDijkstraCertRegistrationDeposit
{
    ...
    constructor(
        { stakeCredential, deposit }: IDijkstraCertRegistrationDeposit,
    ...
    static fromCborObj( cbor: CborObj ): DijkstraCertRegistrationDeposit
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'DijkstraCertRegistrationDeposit'");

        return new DijkstraCertRegistrationDeposit({
