...
function rewardsMapFromCborObj( cObj: CborObj ): RewardsMap
{
    ...
    throw new Error(`Invalid CBOR fromat for "DijkstraMoveInstantRewardsCert"`);
...
export interface IDijkstraMoveInstantRewardsCert {
    source: InstantRewardsSource,
    destination: RewardsMap | Coin
}

/** @deprecated */
export class DijkstraMoveInstantRewardsCert
    implements ToCbor, ToJson, ICert
{
    ...
    constructor(
        { source, destination }: IDijkstraMoveInstantRewardsCert,
    ...
    )
    {
        ...
        )) throw new Error("invalid 'source' while constructing 'DijkstraMoveInstantRewardsCert'");
        ...
        ))throw new Error("invalid 'destintaiton' while constructing 'DijkstraMoveInstantRewardsCert'");
    ...
    static fromCborObj( cObj: CborObj ): DijkstraMoveInstantRewardsCert
    {
        if(!( 
        ...
        return new DijkstraMoveInstantRewardsCert({
