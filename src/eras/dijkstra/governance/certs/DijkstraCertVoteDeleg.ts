...
export interface IDijkstraCertVoteDeleg {
    stakeCredential: Credential,
    drep: DRepLike
}

export class DijkstraCertVoteDeleg
    implements ICert, IDijkstraCertVoteDeleg
{
    ...
    constructor(
        { stakeCredential,drep }: IDijkstraCertVoteDeleg,
    ...
    static fromCborObj( cbor: CborObj ): DijkstraCertVoteDeleg
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'DijkstraCertVoteDeleg'");

        return new DijkstraCertVoteDeleg({
