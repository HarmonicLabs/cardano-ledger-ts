...
export interface IDijkstraAuxiliaryData {
    metadata?: TxMetadata;
    ...
    plutusV4Scripts?: (PlutusScriptJsonFormat<ScriptType.PlutusV4 | "PlutusScriptV4"> | Script<ScriptType.PlutusV4>)[]; // aux_data_map key 5 (Dijkstra)
}
...
export class DijkstraAuxiliaryData
    implements IDijkstraAuxiliaryData, ToCbor, ToJson
{
    ...
    readonly plutusV4Scripts?: Script<ScriptType.PlutusV4>[]; // aux_data_map key 5 (Dijkstra)
    ...
    constructor(
        auxData: IDijkstraAuxiliaryData,
        readonly cborRef: SubCborRef | undefined = undefined
    )
    {
        if(!(
            hasOwn( auxData, "metadata" )
        ))throw new Error("'DijkstraAuxiliaryData' is missing 'metadata' field");
        ...
        ))throw new Error("'DijkstraAuxiliaryData' :: 'metadata' field was not instance of 'TxMetadata'");
        ...
        // -------------------------------- plutus v4 (Dijkstra) -------------------------------- //
        if( plutusV4Scripts !== undefined )
        {
            if(!( Array.isArray( plutusV4Scripts ) ))
            throw new Error("invalid plutusV4Scripts field");

            this.plutusV4Scripts = plutusV4Scripts.map( plutusScript =>
                plutusScript instanceof Script ? plutusScript : Script.fromJson( plutusScript )
            );
        }
        else
        {
            this.plutusV4Scripts = undefined;
        }
    ...
    toCborObj(): CborTag
    {
        ...
        return new CborTag(
            ...
            new CborMap([
                ...
                this.plutusV4Scripts === undefined || this.plutusV4Scripts.length === 0 ? undefined :
                {
                    k: new CborUInt( 5 ),
                    v: scriptArrToCbor( this.plutusV4Scripts )
                }
            ].filter( elem => elem !== undefined ) as CborMapEntry[])
        )
    }

    static fromCbor( cStr: CanBeCborString ): DijkstraAuxiliaryData
    {
        return DijkstraAuxiliaryData.fromCborObj( Cbor.parse( forceCborString( cStr ), { keepRef: true } ) );
    }
    
    static fromCborObj( cObj: CborObj ): DijkstraAuxiliaryData
    {
        ...
        {
            return new DijkstraAuxiliaryData({
        ...
        if( cObj instanceof CborArray )
        {
            ...
            ))throw new InvalidCborFormatError("DijkstraAuxiliaryData")
        ...
        */
        ...
        // console.log("DijkstraAuxiliaryData.fromCborObj", cObj);
        /*
        ;               metadata: shelley
        ...
        */
        ...
        const [
            ...
            _pV2,
            _pV3,
            _pV4 // aux_data_map key 5 (Dijkstra)
        ] = fields;
        ...
        if (_pV4 !== undefined && !(_pV4 instanceof CborArray)) throw new InvalidCborFormatError("DijkstraAuxiliaryData pV4")
        ...
        return new DijkstraAuxiliaryData({
            ...
            plutusV4Scripts: _pV4 === undefined ? undefined :
                _pV4.array.map( cbor =>
