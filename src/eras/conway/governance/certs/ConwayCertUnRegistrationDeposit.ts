...
export interface IConwayCertUnRegistrationDeposit {
    stakeCredential: Credential,
    deposit: Coin
}

export class ConwayCertUnRegistrationDeposit
    implements ICert, IConwayCertUnRegistrationDeposit
{
    ...
    constructor(
        { stakeCredential, deposit }: IConwayCertUnRegistrationDeposit,
    ...
    static fromCborObj( cbor: CborObj ): ConwayCertUnRegistrationDeposit
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'ConwayCertUnRegistrationDeposit'");

        return new ConwayCertUnRegistrationDeposit({
