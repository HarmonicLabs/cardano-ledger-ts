...
export interface IConwayCertAuthCommitteeHot {
    coldCredential: Credential,
    hotCredential : Credential,
}

export class ConwayCertAuthCommitteeHot
    implements ICert, IConwayCertAuthCommitteeHot, ToCbor, ToJson
{
    ...
    constructor(
        { coldCredential, hotCredential }: IConwayCertAuthCommitteeHot,
    ...
    static fromCborObj( cbor: CborObj ): ConwayCertAuthCommitteeHot
    {
        if(!(
        ...
        )) throw new Error("Invalid cbor for 'ConwayCertAuthCommitteeHot'");

        return new ConwayCertAuthCommitteeHot({
