...
function rewardsMapFromCborObj( cObj: CborObj ): RewardsMap
{
    ...
    throw new Error(`Invalid CBOR fromat for "ConwayMoveInstantRewardsCert"`);
...
export interface IConwayMoveInstantRewardsCert {
    source: InstantRewardsSource,
    destination: RewardsMap | Coin
}

/** @deprecated */
export class ConwayMoveInstantRewardsCert
    implements ToCbor, ToJson, ICert
{
    ...
    constructor(
        { source, destination }: IConwayMoveInstantRewardsCert,
    ...
    )
    {
        ...
        )) throw new Error("invalid 'source' while constructing 'ConwayMoveInstantRewardsCert'");
        ...
        ))throw new Error("invalid 'destintaiton' while constructing 'ConwayMoveInstantRewardsCert'");
    ...
    static fromCborObj( cObj: CborObj ): ConwayMoveInstantRewardsCert
    {
        if(!( 
        ...
        return new ConwayMoveInstantRewardsCert({
