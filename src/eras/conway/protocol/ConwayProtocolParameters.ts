...
export function isConwayProtocolParameters(something: any): something is ConwayProtocolParameters {
	...
	if (!(isCostModels(pp.costModels) && isConwayPParamsPoolVotingThresholds(pp.poolVotingThresholds) && isConwayPParamsDrepVotingThresholds(pp.drepVotingThresholds))) return false;
...
export function isPartialConwayProtocolParameters(something: object): something is Partial<ConwayProtocolParameters> {
	...
	if (!((pp.costModels === undefined || isCostModels(pp.costModels)) && (pp.poolVotingThresholds === undefined || isConwayPParamsPoolVotingThresholds(pp.poolVotingThresholds)) && (pp.drepVotingThresholds === undefined || isConwayPParamsDrepVotingThresholds(pp.drepVotingThresholds)))) return false;
...
export function partialConwayProtocolParametersFromCborObj(cObj: CborObj): Partial<ConwayProtocolParameters> {
	if (!(cObj instanceof CborMap)) throw new Error(`Invalid CBOR format for "Partial<ConwayProtocolParameters>"`);
