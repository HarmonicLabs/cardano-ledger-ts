...
import { MaryProtocolParameters, isPartialProtocolParameters, partialProtocolParametersFromCborObj, partialProtocolParametersToCborObj, partialProtocolParamsToJson } from "./MaryProtocolParameters";
...
export type LegacyPPUpdateMap = {
    ...
    changes: Partial<MaryProtocolParameters>
}[];
