...
export interface IMaryTxWitnessSet {
...
export function isIMaryTxWitnessSet( set: object ): set is IMaryTxWitnessSet
{
...
export class MaryTxWitnessSet
    implements IMaryTxWitnessSet, ToCbor, ToJson
{
    ...
    **/
    ...
    )
    {
        ...
        const defGetter = ( name: keyof IMaryTxWitnessSet, get: () => any ) =>
        {
        ...
        function defGetterArr( name: keyof IMaryTxWitnessSet, elems?: Cloneable<any>[] )
        {
            let _elems = elems ?? [];
            defGetter(
                name,
    ...
    static fromCbor( cStr: CanBeCborString ): MaryTxWitnessSet
    {
        return MaryTxWitnessSet.fromCborObj( Cbor.parse( forceCborString( cStr ), { keepRef: true } ) );
    }
