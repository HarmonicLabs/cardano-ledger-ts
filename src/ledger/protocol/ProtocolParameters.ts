...
import {
  ...
  isPParamsPoolVotingThresholds,
  poolVotingThresholdsToCborObj,
  tryGetPParamsPoolVotingThresholdsFromCborObj,
} from "./PParamsPoolVotingThresholds";
import {
  PParamsDrepVotingThresholds,
  drepVotingThresholdsToCborObj,
  isPParamsDrepVotingThresholds,
  tryGetPParamsDrepVotingThresholdsFromCborObj,
} from "./PParamsDrepVotingThresholds";
import {
  IProtocolVersion,
  isIProtocolVersion,
  ProtocolVersion,
...
export function isProtocolParameters(
  something: any,
...
export function isPartialProtocolParameters(
  something: object,
...
export function partialProtocolParametersToCborObj(
  ...
  return new CborMap(
    [
      ...
      protocolVersion === undefined
        ? undefined
        : kv(14, new ProtocolVersion(protocolVersion).toCborObj()),
      ...
      pps.poolVotingThresholds
        ? kv(25, poolVotingThresholdsToCborObj(pps.poolVotingThresholds))
        : undefined,
      pps.drepVotingThresholds
        ? kv(26, drepVotingThresholdsToCborObj(pps.drepVotingThresholds))
        : undefined,
...
export function partialProtocolParametersToData(
  pps: Partial<ProtocolParameters>,
): Data {
...
export function partialProtocolParametersFromCborObj(
  cObj: CborObj,
  ...
  try {
    protocolVersion = _protocolVersion
      ? ProtocolVersion.fromCborObj(_protocolVersion)
      : undefined;
  } catch {}
  ...
  return {
    ...
    poolVotingThresholds: tryGetPParamsPoolVotingThresholdsFromCborObj(
      _poolVotingThresholds,
    ),
    drepVotingThresholds: tryGetPParamsDrepVotingThresholdsFromCborObj(
      _drepVotingThresholds,
    ),
    minCommitteSize: fromUIntOrUndef(_minCommitteSize),
    committeeTermLimit: fromUIntOrUndef(_committeeTermLimit),
    governanceActionValidityPeriod: fromUIntOrUndef(
      _governanceActionValidityPeriod,
    ),
